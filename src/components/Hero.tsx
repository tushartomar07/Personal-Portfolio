  ...
  return (
    <section className="pt-32 pb-16 md:pt-40 md:pb-20 overflow-hidden relative bg-transparent">
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute top-40 left-8 md:left-20 w-16 h-20 animate-float opacity-10">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-full w-full text-portfolio-blue" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="absolute top-60 right-8 md:right-32 w-16 h-20 animate-pulse opacity-10">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-full w-full text-portfolio-blue" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="absolute bottom-40 right-12 md:left-1/3 w-14 h-14 animate-slow-pulse opacity-10">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-full w-full text-portfolio-blue" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="absolute bottom-60 left-8 md:right-1/4 w-20 h-20 animate-float-delayed opacity-10">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-full w-full text-portfolio-blue" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
